...
export class NavigationService
{
    ...
    onHorizentalNavigationModelChange: BehaviorSubject<any> = new BehaviorSubject({});
    navigationModel: NavigationModel;
    flatNavigation: any[] = [];
    horizentalNavigationModel: any[] = [];

    constructor()
    {
        this.navigationModel = new NavigationModel();
        this.horizentalNavigationModel = this.navigationModel.model[0].children;
        this.onNavigationModelChange.next(this.navigationModel.model);
        this.onHorizentalNavigationModelChange.next(this.horizentalNavigationModel);
    }
    ...
    /**
     * Get horizental navigation model
     *
     * @returns {any[]}
     */
    getHorizentalNavigationModel()
    {
        return this.horizentalNavigationModel;
    }

    /**
     * Set the horizental navigation model
     *
     * @param model
     */
    setHorizentalNavigationModel(model)
    {
        this.horizentalNavigationModel = model;
        this.onHorizentalNavigationModelChange.next(this.horizentalNavigationModel);
    }
